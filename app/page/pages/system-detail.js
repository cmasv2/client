/**
 ...
 07/31/2015
 */
define(["durandal/app", "knockout", "bootstrap", "viewmodels/component-2", "viewmodels/component-5", "viewmodels/component-detail-system"], function (app, ko, bootstrap, Component2, Component5, ComponentDetailSystem) {
    return function () {
        ...
        me.activate = function (sys, id, idc) {
            var up = buff.find(buff.getByKey("LocationAll"), "code", sys);
            ...
            id != undefined ? me.comp2(new Component5(initbuff(id, ""), id, idc)) : me.comp2(new ComponentDetailSystem(initbuff(sys, "_DETAIL")))
        }
    }
});
