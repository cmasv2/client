        ...
        return function () {
            ...
            function ca(a){
                ...
                for(var i = 0;i<a.length;i++){
                    msg += "<span class=" + sa(a[i])+ ">" + a[i].text + a[i].a + "/" + a[i].b + " (" +  sa(a[i],0) + ")</span><br/>";
                }
                return msg;
            }
            me.compositionComplete = function () {
                var inf = app.buff.getByKey('CONFIG_INFO');
                var msg = ca([{text:"Location: ",a: count('LocationAll','type', 'location'),b:inf.l},
                            {text:"System: ",a: count('LocationAll','type', 'system'),b:inf.s},
                            {text:"Unit: ",a: count('LocationAll','type', 'unit'),b:inf.u},
