    ...
    function (app, ko, bootstrap, Component5, ComponentDetailSystem) {
        return function () {
            ...
            function SelectTree(o, x, y) {
                for (var p in o) {
                    if (o[p].code == x || o[p].code == y) {
                        o[p].state.selected = o[p].state.opened = 1;
                    }
                    else {
                        o[p].state.selected = o[p].state.opened = 0;
                    }
            ...
            me.activate = function (sys, id, idc) {
                ...
                if (sys != undefined) {
                    ...
                    me.compoment2(new ComponentDetailSystem(initbuff("CMAS", "_DETAIL")));
                }
            };
