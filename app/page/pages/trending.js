        ...
        function addChannelTrending(channel, i) {
            if (channel) {
                ...
                apis.getHistories(channelName, fromTime, toTime).then(function (r) {
                    ...
                    app.showMessage("Url: api/ChannelHistories/" + channelName + "?filter[where][createdAt][gt]=" + fromTime + "&filter[where][updatedAt][lt]=" + toTime + "&access_token=" + localStorage.getItem('swagger_accessToken') + "<br/>" + e.responseText, "Error", ['Yes']);
                });
