        ...
        return function (cf) {
            ...
            function Lis(c) {
                ...
                var cv = function (value) {
                    ...
                    {
                        if(c.type == "1")
                            c.value(value?c._1:c._0);
                        if(c.type == "2")
                            c.value(c.text + "<b>" + number_format(Math.round(value * 10) / 10)) + "</b>";
						if(c.type == "3")
							if(value != undefined)
								c.value(c.text1);
                        if (c.type == "4") {
						...
						c.value(number_format(Math.round(value * 10) / 10));
                }
                if (Soc.connected())
            ...
            for (var i = 0; i < cf[0].channels.length; i++) {
                ...
                /*if (it["value1"] != undefined && it["value1"]) {
