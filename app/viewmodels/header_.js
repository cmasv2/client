...
//            rest.getGuide(me.guideID).then(function (response){
//                if (response) {
...
//            });
        ...
        headerViewModel.activate = function() {
            ...
            if (me.config.pageName) {
                me.pageName(config.pageName)
            }

            if (me.config.pageDescription) {
                me.pageDescription(config.pageDescription)
            }
