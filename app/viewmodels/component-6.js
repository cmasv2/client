/**
 ...
 07/31/2015
 */
define(["durandal/app", "knockout", "moment"], function (app, ko, Moment) {
    return function (c) {
        var me = this, buff = app.buff;
        me.cf = ko.observableArray([]);
        function AlarmAck(a) {
        }

        function pusha(a) {
            if (a != undefined)if (a.id != undefined)me.cf.push(a)
        }

        me.activate = function () {
            for (var i = 0; i < c.length; i++)pusha(c[i].alarmWatcher)
        };
