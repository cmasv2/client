define(['durandal/app', 'plugins/router', "knockout", "moment", "./../bindings/status-binding"], function (app, router, ko, Moment) {
    return function (cf) {
