/**
 ...
 07/31/2015
 */
define(['durandal/app', "knockout", 'plugins/router', "jquery","q","./../data/configGui", "css!../../css/login.css"],
    function (app, ko, router, $, Q, conF) {
        return function () {
            var me = this, conf = conF(), a = app.services.getService("apis");
            app.buff = $.buff(conf.info);
            //app.buff = $.buff(JSON.parse(decode(conf.configView[0].value)));
            //console.log(JSON.parse(decode(conf.configView[0].value)));
