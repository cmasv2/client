...
;(function($,Canvas2Image) {
    ...
    var options = {
        ...
        menu: {
            ...
            menuHtml: "<ul class='menu-bar'><li title='Save as image...'><span class='helper'></span><span class='icon' style='font-size: larger'>&#xe001;</span><ul><li event='click' handler='saveAsPng'>Save as PNG...</li><li event='click' handler='saveAsJpeg'>Save as JPEG...</li><li event='click' handler='saveAsBmp'>Save as BMP...</li></ul></li><li title='Toggle navigation control' event='click' handler='handleNavigationControl'><span class='helper'></span><span class='icon' style='font-size: larger;'>m</span></li></ul>"
        }
    };
    $.plot.plugins.push({
        init: init,
