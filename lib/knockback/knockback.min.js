    ...
    return function (factory) {
        ...
        kb.Store = function () {
            ...
            Store.prototype.register = function (obj, observable, options) {
                ...
                this.observable_records.push({obj: obj, observable: observable, creator: creator});
                return observable
            };
            ...
            Store.prototype.findOrReplace = function (obj, creator, observable) {
                ...
                if ((index = this.findIndex(obj, creator)) < 0) {
                    return this.register(obj, observable, {creator: creator})
                } else {
                ...
                return kb.ignore(function (_this) {
                    return function () {
                        ...
                        if (_.isString(options) || ko.isObservable(options)) {
                            create_options = _this.create_options = {key: options}
                        } else {
                        ...
                        kb.EventWatcher.useOptionsOrCreate({event_watcher: event_watcher}, model, _this, {
                            emitter: _this.model,
        ...
        kb.ViewModel = function () {
            ...
            function ViewModel(model, options, view_model) {
                return kb.ignore(function (_this) {
                    return function () {
                        ...
                        event_watcher = kb.utils.wrappedEventWatcher(_this, new kb.EventWatcher(model, _this, {emitter: _this.model}));
            ...
            ViewModel.prototype.mapObservables = function (model, mappings) {
                ...
                for (vm_key in mappings) {
                    ...
                    mapping_info = _.isString(mapping_info) ? {key: mapping_info} : _.clone(mapping_info);
            ...
            function CollectionObservable(collection, options) {
                return kb.ignore(function (_this) {
                    return function () {
                        ...
                        create_options = _this.create_options = {store: kb.Store.useOptionsOrCreate(options, collection, observable)};
